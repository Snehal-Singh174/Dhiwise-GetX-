...
class AppStyle {
  ...
  static TextStyle txtPoppinsRegular18Black900 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular16WhiteA700 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium17Black900 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      17,
    ),
  ...
  static TextStyle txtPoppinsRegular127 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      12.7,
    ),
  ...
  static TextStyle txtPoppinsRegular17 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      17,
    ),
  ...
  static TextStyle txtPoppinsMedium25 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      25,
    ),
  ...
  static TextStyle txtPoppinsSemiBold22 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      22,
    ),
  ...
  static TextStyle txtPoppinsRegular12Gray500 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsLight12 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsSemiBold30 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      30,
    ),
  ...
  static TextStyle txtPoppinsRegular14Orange700 = TextStyle(
    color: ColorConstant.orange700,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtQuicksandRegular32 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular11 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      11,
    ),
  ...
  static TextStyle txtPoppinsMedium14Orange700 = TextStyle(
    color: ColorConstant.orange700,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtPoppinsRegular15Black900 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      15,
    ),
  ...
  static TextStyle txtPoppinsMedium17 = TextStyle(
    color: ColorConstant.gray500,
    fontSize: getFontSize(
      17,
    ),
  ...
  static TextStyle txtPoppinsRegular15Green600 = TextStyle(
