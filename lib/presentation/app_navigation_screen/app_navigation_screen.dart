...
import 'package:snehal_s_application64/presentation/social_account_link_alert_bottomsheet/social_account_link_alert_bottomsheet.dart';
import 'package:snehal_s_application64/presentation/social_account_link_alert_bottomsheet/controller/social_account_link_alert_controller.dart';
import 'package:snehal_s_application64/presentation/logout_bottomsheet/logout_bottomsheet.dart';
import 'package:snehal_s_application64/presentation/logout_bottomsheet/controller/logout_controller.dart';
  ...
  onTapSocialAccountLinkAlert() {
    Get.bottomSheet(
      SocialAccountLinkAlertBottomsheet(
        Get.put(
          SocialAccountLinkAlertController(),
        ),
      ),
